...
class BDOAIAnalyzer:
    ...
    def _create_analysis_prompt(self, patch_data: Dict[str, Any], content: str) -> str:
        ...
        6. **Item Changes**
        - Specific item changes with before/after analysis
        - New items or systems introduced
        - Crafting or gathering changes

        7. **Events and Promotions**
        - Upcoming events related to this patch
        - Promotions or time-limited content
